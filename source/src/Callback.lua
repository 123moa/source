...
data = {
{
{text = '‹sᴏᴜʀᴄᴇ›ダ⸢ᴠᴇɢᴀ♪⸥', url = 'http://t.me/'..chsource..''}, 
},
}
}
...
msalm = "߷ وسوينا لك حساب في بنك فيجا 🏦\n߷ وشحنالك 50 جنيه 💵 هدية\n\n⇜ رقم حسابك ↢ ( `"..cccall.."` )\n⇜ نوع البطاقة ↢ ( "..ccctype.." )\n⇜ فلوسك ↢ ( 50 جنيه 💵 )\n⇜ شخصيتك : "..shakseshakse.."\n⇜ دولتك : 🇸🇾"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
type = "photo",
media = ph,
caption = '*  *[آهــلٓآ بَٰــڪ فٍُــيَ س๋͜‏ــۄرس๋͜‏ فيجا 🕷️🔥](t.me/SOURCEVEGA)*\n\n*[ آقٍُـۄيَ مــصَٰـآنــعَِٰ س๋͜‏ــۄࢪس๋͜‏ــآټِٖ عَِٰــلٓيَ آلٓټِٖـلٓيَـج ـࢪآم](t.me/SOURCEVEGA) *\n\n*[ س๋͜‏ؤࢪس๋͜‏ فيجا عَِٰلٓيَ منعَِٰ ټِٖصَٰفٍُيَه آلٓمج ـمۄعَِٰآټِٖ ۄح ـمآيَټِٖهآ](t.me/SOURCEVEGA)*\n\n*[ لٓــديَــنــآ ټِٖـنصَٰيَــبَٰ بَٰـۄټِٖــآټِٖ مــيَـۄزڪ آيَــضَِٖـآ](t.me/SOURCEVEGA)*\n\n*[لٓديَــنآ ټِٖنـصَٰيَــبَٰ ح ـس๋͜‏ــآبَٰــآټِٖ ټِٖــلٓيَــثُِٖــۄن](t.me/SOURCEVEGA) *\n\n*[آلٓس๋͜‏ۄࢪس๋͜‏ مزۄد بَٰج ـميَعَِٰ آلآلٓعَِٰآبَٰ ۄآلٓمميَزآټِٖ آلٓمټِٖطِٖۄࢪه](t.me/SOURCEVEGA) *\n\n*[ټِٖآبَٰعَِٰ قٍُنآه آلٓټِٖح ـديثُِٖآټِٖ ۄآلٓټِٖطِٖۄيَࢪآټِٖ لٓيَصَٰلٓڪ ڪلٓ ج ـديَد لٓديَنآ](t.me/SOURCEVEGA) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ ٰ☬ ⇣ اصنع بوتك الان ⇣ ☬ › .', url = "https://t.me/VIIIIIIIIIIIIPVEGA_bot"}
},
{
{text = '« عودة', callback_data=IdUser..'/halo'},
},
{
...
type = "photo",
media = ph,
caption = '[ ⩹⌯⊷★父‹sᴏᴜʀᴄᴇ›ダ⸢ᴠᴇɢᴀ♪⸥父★⊶⌯⩺ ](t.me/SOURCEVEGA) \n [ 🤖┇⌯ ⋆⃟➼𝙑𝙀𝙂𝘼 𝙎𝙊𝙐𝙍𝘾𝙀 ꕸ ˹🕷️🔥˼⁩](t.me/SOURCEVEGA) \n [ ⚙️┇⌯ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ](t.me/SUBBORT_RINO) \n [ 🏑┇⌯ [˚₊· ͟͟͞͞➳❥❬ ғɪʟᴇs 𝚅𝙴𝙶𝙰 𝚂𝙾𝚄𝚁𝙲𝙴 ❭߷ °](t.me/SOURCEVEGA) \n [ 🏅┇⌯ ߷ !! 𝙳𝙴𝚅 𝚂𝙾𝚄𝚁𝙲𝙴ᵛ͢ᵎᵖ ](t.me/KIINGVEGA) \n [⩹⌯⊷★父‹sᴏᴜʀᴄᴇ›ダ⸢ᴠᴇɢᴀ♪⸥父★⊶⌯⩺](t.me/SOURCEVEGA) \n [𖥔 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻  𝑺𝑶𝑼𝑹𝑪𝑬 ⏎](t.me/SOURCEVEGA) \n\n',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ ٰ☬ ⇣ اصنع بوتك الان ⇣ ☬ › .', url = "https://t.me/MAK_RINO_BOT"}
},
{
{text = '« عودة', callback_data=IdUser..'/halo'},
},
...
type = "photo",
media = ph,
caption = '*  *[ 🎧╢߷ لأستخدام البوت اغاني وفيديو كول](t.me/SOURCEVEGA)*\n*[ 🎥╢߷ اكتب » /music ثم أضغط الأوامر](t.me/SOURCEVEGA) *\n*[ 🕹╢اكتب /key لاظهار كيبورد الاعضاء](t.me/SOURCEVEGA)*\n*[ 🌐╢߷ وظيفتي حماية المجموعات](t.me/SOURCEVEGA)*\n*[ ✅╢߷ لتفعيل البوت عليك اتباع مايلي](t.me/SOURCEVEGA) *\n*[ 🔘╢߷ أضِف البوت إلى مجموعتك](t.me/SOURCEVEGA) *\n*[ ⚡️╢߷ ارفعهُ » مشرف + اكتب تفعيل](t.me/SOURCEVEGA) *\n*[ ⬆️╢߷ سيتم ترقيتك مالك في البوت](t.me/SOURCEVEGA) *\n*[ 🚨╢߷ لكي أعمل معك بشكل صحيح](t.me/SOURCEVEGA) *\n*[ 📣╢߷ تأكد » من اعطائي حذف الرسائل](t.me/SOURCEVEGA) *\n*[ 📣╢߷ تأكد » من تفعيل الألعاب](t.me/SOURCEVEGA) *\n*[ 📣╢߷ تأكد » من تفعيل الرفع](t.me/SOURCEVEGA) *\n*[ 📣╢߷ تأكد » من تفعيل ردود السورس](t.me/SOURCEVEGA) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '‹sᴏᴜʀᴄᴇ›ダ⸢ᴠᴇɢᴀ♪⸥', url = 't.me/'..chsource..''}, 
},
}
}
...
{
{text = ' ⸢ 𝒖𝒑𝒅𝒂𝒕𝒆 ߷ 𝒃𝒐𝒕 ⸥ ', url="t.me/SOURCEVEGA"},
},
}
}
local TextHelp = [[*
