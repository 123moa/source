...
local TextHelp = [[*
🔺️╎ مرحبا بك في { قسم } العاب السورس ߷
...
return send(msg_chat_id,msg_id,'᥀ مرحبا بك عزيزي المطور ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'᥀ مرحبا بك عزيزي العضو في قسم مبرمج السورس', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'᥀ مرحبا بك عزيزي العضو في القسم الديني', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'᥀ مرحبا بك عزيزي العضو في قسم التحميل من موقع اليوتيوب مباشر 🎥', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'᥀ مرحبا بك عزيزي العضو في قسم العاب السورس والمجموعات 🎮', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'᥀ مرحبا بك عزيزي في قسم البحث يمكنك كتابه ( بحث ) واسم المطرب او الاغنيه الي تريدها ✅', 'md', false, false, false, false, reply_markup)
