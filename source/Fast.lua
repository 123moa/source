...
devsource = Redis:get(Fast..'devsource') or "KIINGVEGA"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,1702284844,1702284844}
...
if tonumber(senderr) == 1702284844 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 1702284844 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
...
if msg.sender_id.user_id == tonumber(1702284844) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج كيمي نورت الجروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(1702284844) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج سلفير نورت الجروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(777) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزي المطور مآنو رتبتك هنآ صآحب الليله دي - ✅","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(999) then
...
local name_parlo = bot.getUser(1702284844).first_name.." "..bot.getUser(1702284844).last_name
local caption = "اليك قائمه مطورين سورس فيجا :"
if tonumber(UserId_Info.id) ~= 1702284844 then
...
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@1702284844'},
},
LocalDev
,
{
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/SOURCEVEGA ", 'md', true)
end
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(1702284844) then
...
if text == 'كيمي' or text == 'مطور فيجا' then
photo = "https://t.me/KIINGVEGA"
local T =[[
[ٓ  ☇⸢ᴅᴇᴠᴇʟᴏᴘᴇʀ‹⋆ダsᴏᴜʀᴄᴇ➻⸢ᴠᴇɢᴀ♪⸥❄️](t.me/SOURCEVEGA )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '☇ ᴋɪᴍᴍʏ ダ ᴠᴇɢᴀ ♪', url = "https://t.me/KIINGVEGA"}
},
{
{text = '‹ ٰ𖣂 ߷ ⸢ᴠᴇɢᴀ♪⸥ ߷ 𖣂 ›', url = "https://t.me/KiMY_X_bot"}
},
}
...
keyboard.inline_keyboard = {
{
{text = '✧ اوامر البنك ✧', url = "https://t.me/SOURCEVEGA/5369"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ☬ ⇣ اصنع بوتك الان ⇣ ☬ › .', url = "https://t.me/@M_HeMaYa_VEGA_bot"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if msg.sender_id.user_id == tonumber(1702284844) then
send(msg_chat_id,msg_id,"߷ انت كيمي مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(1702284844) then
send(msg_chat_id,msg_id,"߷ انت زين مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(888) then
send(msg_chat_id,msg_id,"߷ انت مانو مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(00) then
send(msg_chat_id,msg_id,"انت [فيجا صآحبه الليله دي] يقلبي 🥺♥","md",true)
elseif msg.sender_id.user_id == tonumber(00) then
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(1702284844) then
local txx = "\n"
...
{{text = '- 𝕊𝕆𝕌ℝℂ𝔼 𝕍𝔼𝔾𝔸 𖤐 ߷', url = "https://t.me/SOURCEVEGA"}},
}
}
...
keyboard.inline_keyboard = {
{
{text = '‹sᴏᴜʀᴄᴇ›ダ⸢ᴠᴇɢᴀ♪⸥',url="t.me/SOURCEVEGA"}
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = '‹sᴏᴜʀᴄᴇ›ダ⸢ᴠᴇɢᴀ♪⸥', url = "https://t.me/SOURCEVEGA"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@SOURCEVEGA")
sleep(1)
...
if text == 'كيمي' or text == 'مبرمج السورس' or text == 'فيجا' then  
local UserId_Info = bot.searchPublicChat("KIINGVEGA")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
data = {
{
{text = '‹sᴏᴜʀᴄᴇ›ダ⸢ᴠᴇɢᴀ♪⸥', url = 'http://t.me/'..chsource..''}, {text = '◜ ꪔY ժᥱ᥎◞', url = 't.me/'..devsource}, 
},
{
...
if text == '‹sᴏᴜʀᴄᴇ›ダ⸢ᴠᴇɢᴀ♪⸥' or text == 'قناه السورس' then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[ٓ ˚₊· ͟͟͞͞➳❥❬ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙲𝙷 𝚅𝙴𝙶𝙰 𝚂𝙾𝚄𝚁𝙲𝙴 ❭߷ °](t.me/SOURCEVEGA)
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
...
keyboard.inline_keyboard = {
{
{text = '📚 معلومات 📚 ', callback_data = msg.sender_id.user_id..'/zxhaut'},{text = '🔺 حــول 🔻 ',  callback_data = msg.sender_id.user_id..'/lhaui'},
},
{
{text = Name_dev, url = "t.me/"..UName_dev },
},
